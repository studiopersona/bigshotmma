	...
	<table style="width:600px; max-width:600px; margin:15px auto; padding:0; border-collapse:collapse; background:#fff;" width="600" align="center">
        ...
        <tr>
            <td style="padding: 24px;">
                <p style="font-size: 14px; color: #222; margin-bottom: 16px;">We received your withdrawal request on {{ date('m/d/Y') }} for the amount of ${{ number_format((float)$amount, 2) }}. Your request will normally be processed within 48 hours. If you've requested a check it may take 5 - 8 days to receive depending on your location.</p>
