...
},{"../index":44,"../libs/d":45}],34:[function(require,module,exports){
'use strict';
...
},{"../index":44,"vue":32,"vue-hot-reload-api":6}],35:[function(require,module,exports){
'use strict';
...
},{"../auth":33,"../index":44,"vue":32,"vue-hot-reload-api":6}],36:[function(require,module,exports){
'use strict';
...
},{"../auth":33,"../index":44,"vue":32,"vue-hot-reload-api":6}],37:[function(require,module,exports){
'use strict';
...
},{"../auth":33,"../index":44,"vue":32,"vue-hot-reload-api":6}],38:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        setDecision: function setDecision(fightId) {
            if (fightId) {
                this.fightData[parseInt(fightId, 10)].round = 5;
                this.fightData[parseInt(fightId, 10)].minute = 5;
            }
...
},{"../auth":33,"../index":44,"../libs/d.js":45,"vue":32,"vue-hot-reload-api":6}],39:[function(require,module,exports){
'use strict';
...
},{"../auth":33,"../index":44,"vue":32,"vue-hot-reload-api":6}],40:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        tallyPoints: function tallyPoints(outcome) {
            var vm = this;
...
},{"../auth":33,"../index":44,"vue":32,"vue-hot-reload-api":6}],41:[function(require,module,exports){
'use strict';
...
},{"../auth":33,"vue":32,"vue-hot-reload-api":6}],42:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        combineResults: function combineResults(results) {
            var vm = this;

            results.forEach(function (result, index) {
                var fightIndex = vm.fightsList.findIndex(function (fight) {
                    return parseInt(fight.id, 10) === parseInt(result.fightResults.fight_id, 10);
                });

                vm.fightsList[fightIndex].$set(results, result.fightResults);
            });
        },
        findPowerUp: function findPowerUp(powerUp) {
            return powerUp.power_up_id === parseInt(this.powerUpId, 10);
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div :working=\"working\">\n    <header class=\"pageHeader\" :working.sync=\"working\">\n        <h1 class=\"pageHeader__header\">Fighters {{ playerPicks.length }}/5 Chosen</h1>\n        <h4 class=\"pageHeader__subheader\">{{ totalPowerUps }}/3 Power-ups Used</h4>\n    </header>\n    <div class=\"fightsList\">\n        <ul>\n            <li class=\"fightsList__item\" @click=\"showFight(result.fightResults.fight_id)\" v-for=\"result in resultsList\">\n                <div class=\"container-fluid fightsList__fightersWrap\" data-fight-id=\"{{ result.fightResults.fight_id }}\">\n                    <div class=\"col-xs-50 fightsList__fighterStatsWarp\">\n                        <div class=\"col-xs-40 fightsList__fighterWrap\">\n                            <div class=\"fightsList__fighterImgWrap\" data-fight-id=\"{{ result.fightResults.fight_id }}\">\n                                <img :class=\"['fightsList__fighter', (result.fightResults.fight.fighters[0].pivot.odds > result.fightResults.fight.fighters[1].pivot.odds) ? 'favorite' : '']\" :src=\"'public/image/fighters/' + result.fightResults.fight.fighters[0].fighter_image_name\" alt=\"{{ result.fightResults.fight.fighters[0].firstname }} {{ result.fightResults.fight.fighters[0].lastname }} Image\" data-fighter-id=\"{{ result.fightResults.fight.fighters[0].id }}\">\n                                <div class=\"fightsList__selectedIndicatorWrap\">\n                                    <div :class=\"['fightsList__selectedIndicator', (parseInt(result.fightResults.fight.fighters[0].pivot.odds, 10) > parseInt(result.fightResults.fight.fighters[1].pivot.odds, 10)) ? 'favorite' : '']\" data-fighter-id=\"{{ result.fightResults.fight.fighters[0].id }}\">\n                                        <span>\n                                            {{ (parseInt(result.fightResults.fight.fighters[0].pivot.odds, 10) &gt; parseInt(result.fightResults.fight.fighters[1].pivot.odds, 10)) ? 'Favorite (+3)' : 'Underdog (+5)' }}\n                                        </span>\n                                    </div>\n                                </div>\n                            </div>\n                        </div>\n                        <div class=\"col-xs-60\">\n                            <div class=\"fightsList__fighterName\">\n                                {{ result.fightResults.fight.fighters[0].firstname }} {{ result.fightResults.fight.fighters[0].lastname }}\n                            </div>\n                            <div class=\"fightsList__fighterHeight\">\n                                {{ result.fightResults.fight.fighters[0].height_ft }}' {{ result.fightResults.fight.fighters[0].height_in }}\"\n                                {{ result.fightResults.fight.fighters[0].weight_lbs }}lbs.\n                            </div>\n                            <div class=\"fightsList__fighterRecord\">\n                                {{ result.fightResults.fight.fighters[0].wins }} - {{ result.fightResults.fight.fighters[0].loses }} - {{ result.fightResults.fight.fighters[0].draws }}\n                            </div>\n                            <div :class=\"['fightsList__spread', result.fightResults.fight.fighters[0].pivot.odds > 0 ? 'favorite' : '']\">\n                                {{ result.fightResults.fight.fighters[0].pivot.odds }}\n                            </div>\n                        </div>\n                    </div><!-- .fightsList__fighterStatsWarp -->\n                    <div class=\"col-xs-50 fightsList__fighterStatsWarp\">\n                        <div class=\"col-xs-60 right\">\n                            <div class=\"fightsList__fighterName\">\n                                {{ result.fightResults.fight.fighters[1].firstname }} {{ result.fightResults.fight.fighters[1].lastname }}\n                            </div>\n                            <div class=\"fightsList__fighterHeight\">\n                                {{ result.fightResults.fight.fighters[1].height_ft }}' {{ result.fightResults.fight.fighters[1].height_in }}\"\n                                {{ result.fightResults.fight.fighters[1].weight_lbs }}lbs.\n                            </div>\n                            <div class=\"fightsList__fighterRecord\">\n                                {{ result.fightResults.fight.fighters[1].wins }} - {{ result.fightResults.fight.fighters[1].loses }} - {{ result.fightResults.fight.fighters[1].draws }}\n                            </div>\n                            <div :class=\"['fightsList__spread', result.fightResults.fight.fighters[1].pivot.odds > 0 ? 'favorite' : '']\">\n                                {{ result.fightResults.fight.fighters[1].pivot.odds }}\n                            </div>\n                        </div>\n                        <div class=\"col-xs-40  fightsList__fighterWrap\">\n                            <div class=\"fightsList__fighterImgWrap\" data-fight-id=\"{{ result.fightResults.id }}\">\n                                <img :class=\"['fightsList__fighter', (parseInt(result.fightResults.fight.fighters[1].pivot.odds, 10) > parseInt(result.fightResults.fight.fighters[0].pivot.odds, 10)) ? 'favorite' : '']\" :src=\"'public/image/fighters/' + result.fightResults.fight.fighters[1].fighter_image_name\" alt=\"{{ result.fightResults.fight.fighters[1].firstname }} {{ result.fightResults.fight.fighters[1].lastname }} Image\" data-fighter-id=\"{{ result.fightResults.fight.fighters[1].id }}\">\n                                 <div class=\"fightsList__selectedIndicatorWrap\">\n                                    <div :class=\"['fightsList__selectedIndicator', (result.fightResults.fight.fighters[1].pivot.odds > result.fightResults.fight.fighters[0].pivot.odds) ? 'favorite' : '']\" data-fighter-id=\"{{ result.fightResults.fight.fighters[1].id }}\">\n                                        <span>\n                                            {{ (parseInt(result.fightResults.fight.fighters[1].pivot.odds, 10) &gt; parseInt(result.fightResults.fight.fighters[0].pivot.odds, 10)) ? 'Favorite (+3)' : 'Underdog (+5)' }}\n                                        </span>\n                                    </div>\n                                </div>\n                            </div><!-- .fightsList__fighterImgWrap -->\n                        </div><!-- .fightsList__fighterWrap -->\n                    </div><!-- .fightsList__fighterStatsWarp -->\n                </div><!-- .fightsList__fightersWrap -->\n                <div class=\"fightsList__pick\" id=\"{{ result.fightResults.id }}\" data-fight-id=\"{{ result.fightResults.fight_id }}\">\n                    <div class=\"container-fluid\">\n\n\n                    </div>\n                </div>\n            </li>\n        </ul>\n        <div :class=\"loaderClasses\">\n            <div class=\"js-global-loader loader\">\n                <svg viewBox=\"0 0 32 32\" width=\"32\" height=\"32\">\n                    <circle id=\"spinner\" cx=\"16\" cy=\"16\" r=\"14\" fill=\"none\"></circle>\n                </svg>\n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"../auth":33,"../index":44,"vue":32,"vue-hot-reload-api":6}],43:[function(require,module,exports){
'use strict';
...
},{"../auth":33,"../index":44,"babel-runtime/helpers/defineProperty":2,"vue":32,"vue-hot-reload-api":6}],44:[function(require,module,exports){
'use strict';
...
},{"./components/App.vue":34,"./components/ContestLobby.vue":35,"./components/Contests.vue":36,"./components/Events.vue":37,"./components/Fights.vue":38,"./components/Login.vue":39,"./components/PlayerPicks.vue":40,"./components/Register.vue":41,"./components/Results.vue":42,"./components/Standings.vue":43,"vue":32,"vue-resource":20,"vue-router":31}],45:[function(require,module,exports){
(function (process){
'use strict';
