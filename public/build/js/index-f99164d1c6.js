...
var API_URL = 'http://edward.dev/bsmma/api/v1/'; // src/auth/index.js
...
},{"../index":41}],34:[function(require,module,exports){
...
exports.default = {
    ...
    methods: (_methods = {
        ...
        selectFighter: function selectFighter(e) {
            var fightToClose, fightToOpen, fighterImageToDeselect, fighterIndicatorToDeselect, fighterImageToSelect, fighterIndicatorToSelect, pickData;
        ...
        updatePicks: function updatePicks() {
            ...
            if (pickData) {
                ...
                if (pickData.fighterId !== e.target.dataset.fighterId) {
                    this.deselectFighter(pickData.fighterId);

                    pickDataIndex = this.palyerPicks.findIndex(findPick);
                    console.log(pickDataIndex);

                    if (pickDataIndex !== -1) this.playerPicks[pickDataIndex].fighterId = e.target.dataset.fighterId;
    ...
    }, (0, _defineProperty3.default)(_methods, 'selectFighter', function selectFighter(fighterId) {
    ...
    }), (0, _defineProperty3.default)(_methods, 'deselectFighter', function deselectFighter(fighterId) {
...
},{"../auth":33,"babel-runtime/helpers/defineProperty":2,"vue":32,"vue-hot-reload-api":6}],39:[function(require,module,exports){
'use strict';
...
},{"../auth":33,"vue":32,"vue-hot-reload-api":6}],40:[function(require,module,exports){
'use strict';
...
},{"./components/App.vue":34,"./components/ContestLobby.vue":35,"./components/Contests.vue":36,"./components/Events.vue":37,"./components/Fights.vue":38,"./components/Login.vue":39,"./components/Register.vue":40,"vue":32,"vue-resource":20,"vue-router":31}]},{},[41]);
