...
new Vue({
	...
	computed: {
		flipClasses: function flipClasses() {
			return this.flipped ? 'flip-container fliped' : 'flip-container';
		},

		loaderClasses: function loaderClasses() {
			return this.working ? 'loader js-global-loader' : 'loader js-global-loader visuallyhidden';
		}
	},

	components: { Login: _Login2.default, Register: _Register2.default },
	...
	methods: {
		authenticate: function authenticate(e) {
			...
			this.working = true;
			this.$http({
				url: e.target.baseURI + '/api/v1/authenticate',
				method: 'POST',
				data: {
...
},{"./components/Login.vue":28,"./components/Register.vue":29,"vue":27,"vue-resource":16}]},{},[30]);
