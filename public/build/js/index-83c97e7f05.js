...
exports.default = {
    ...
    methods: {
        ...
        fetch: function fetch() {
            this.$http.get(URL.base + '/api/v1/event/' + this.$route.params.event_id + '/results', {}, {
                // Attach the JWT header
                headers: _auth2.default.getAuthHeader()
            }).then(function (response) {
