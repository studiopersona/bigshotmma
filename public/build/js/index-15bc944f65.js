...
exports.default = {
    data: function data() {
        return {
            ...
            paypalEmail: '',
            expYears: [],
            amountIndicators: [false, false, false, false, false],
            alert: {
                body: '',
    ...
    methods: {
        ...
        fetch: function fetch() {
            ...
            this.setAmountIndicators();
        },
        setAmountIndicators: function setAmountIndicators() {
            this.amountIndicators = document.querySelectorAll('span[data-amount]');
        },
        ...
        removeAmountIndicators: function removeAmountIndicators() {
            ...
            for (var i = 0; i < this.amountIndicators.length; ++i) {
                this.amountIndicators[i].classList.remove('show');
            }
        ...
        selectAmount: function selectAmount(index, e) {
            this.removeAmountIndicators().then(function () {
                this.amountIndicators[index].classList.add('show');
            });
        },
