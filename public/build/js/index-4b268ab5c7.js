    ...
    methods: {
        ...
        fetch: function fetch() {
            this.$http.get(URL.base + '/api/v1/contest/' + this.$route.params.contest_id + '/fights', {}, {
                ...
                console.log(response.data.fights[0]);
                this.fightsList = response.data.fights[0].fights;
                this.event = response.data.fights[0].event;
                this.working = false;
