...
var _mobileHeroPadding = require('./lander/mobile-hero-padding');

var _mobileHeroPadding2 = _interopRequireDefault(_mobileHeroPadding);
...
window.onload = function () {
	...
	if ((0, _jquery2.default)(window).width() > 615) {
		...
		if (document.getElementById('powerupsCarousel')) {
			...
			var pc = new _carousel2.default.getInstance({
				...
				$navBtnsWrap: (0, _jquery2.default)('.carousel-nav__wrap'),
	...
	if (document.getElementById('information')) _infoPanels2.default.init();

	if (document.getElementById('contact-form')) _formControl2.default.init({
		formSelector: '#contact-form',
		submitBtnSelector: '#contact-submit'
	});
};

},{"./lander/carousel":4,"./lander/form-control":5,"./lander/hamburger":6,"./lander/hero-sizer":7,"./lander/info-panels":8,"./lander/menu-control":9,"./lander/mobile-hero-padding":10,"./lander/powerup-info":11,"jquery":1,"parsleyjs":2}],4:[function(require,module,exports){
'use strict';
...
var Carousel = function ($, w, undefined) {
    ...
    var init = function init(options) {
        ...
        var determineDirection = function determineDirection(e) {
        ...
        var changeFrame = function changeFrame(moveTo) {
        ...
        var checkLimits = function checkLimits(position) {
            var moveTo;
        ...
        var toggleLeftNavBtn = function toggleLeftNavBtn(turnOn) {
            if (turnOn) {
        ...
        var toggleRightNavBtn = function toggleRightNavBtn(turnOn) {
            if (turnOn) {
...
var formControl = function ($, spinner, w, undefined) {
    ...
    var renderResponse = function renderResponse(json) {
...
}(_jquery2.default, _spinner2.default, window);

exports.default = formControl;

},{"./spinner.js":12,"./xhr.js":13,"jquery":1,"parsleyjs":2}],6:[function(require,module,exports){
'use strict';
...
var heroSizer = function heroSizer(ratio) {
...
var mobileHeroPadding = function mobileHeroPadding(ratio) {
	var heroEl = document.querySelector('.hero');

	var setHeroPadding = function setHeroPadding() {
...
exports.default = mobileHeroPadding;
