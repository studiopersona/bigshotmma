...
exports.default = {
    ...
    computed: {
        ...
        isCurrentCustomer: function isCurrentCustomer() {
...
exports.default = {
    ...
    methods: {
        ...
        confirmRemovePowerUp: function confirmRemovePowerUp(fightId, e) {
            var newPowerUp;
            e.preventDefault();
        ...
        removePowerUp: function removePowerUp(e) {
        ...
        switchFight: function switchFight(e) {
            var fightToClose, fightToOpen, target, position;
